...
import { Languages, Levels } from "@/lib/settings_hook";
...
export default function PvPMatch({ challenge, onComplete }: PvPMatchProps) {
  ...
  const handleComplete = useCallback(async () => {
    ...
    const results: Result = {
      ...
      level: challenge.level as Levels,
      keyboard: challenge.keyboard as KeyboardLayoutNames,
      language: challenge.language as Languages,
