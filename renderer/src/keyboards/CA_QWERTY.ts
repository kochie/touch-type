...
// French Canadian QWERTY — ISO layout; é on bottom row, è/à on home row
export const MACOS_CA_QWERTY: KeyboardLayout = [
  [
  ...
  [
    ...
    new Key("l", {}, "L"),
    new Key(";", { secondaryKey: ":" }),
    new Key("è", { secondaryKey: "È" }, "è"),
    new Key("à", { secondaryKey: "À" }, "à"),
    new Key(
      "Enter",
