...
export const MACOS_NZ_QWERTY: KeyboardLayout = [
  [
  ...
  [
    ...
    new Key("q", {}, "Q"),
    new Key("w", {}, "W"),
    new Key("e", { secondaryKey: "ē" }, "E"),
    new Key("r", {}, "R"),
    new Key("t", {}, "T"),
    new Key("y", {}, "Y"),
    new Key("u", { secondaryKey: "ū" }, "U"),
    new Key("i", { secondaryKey: "ī" }, "I"),
    new Key("o", { secondaryKey: "ō" }, "O"),
    new Key("p", {}, "P"),
    new Key("["),
    new Key("]"),
    new Key("\\"),
