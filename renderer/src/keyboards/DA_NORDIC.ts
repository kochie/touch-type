...
// Danish QWERTY — ISO layout; æ comes before ø in the home row (reversed vs Norwegian)
export const MACOS_DA_NORDIC: KeyboardLayout = [
  [
  ...
  [
    ...
    new Key("k", {}, "K"),
    new Key("l", {}, "L"),
    new Key("æ", { secondaryKey: "Æ" }, "æ"),
    new Key("ø", { secondaryKey: "Ø" }, "ø"),
    new Key("'", { secondaryKey: "*" }),
    new Key(
      "Enter",
