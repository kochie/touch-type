...
// Turkish Q — ISO layout; ğ/ü on QWERTY row, ş/ı on home row, ö/ç on bottom row
export const MACOS_TR_QWERTY: KeyboardLayout = [
  [
    new Key('"', { secondaryKey: "é" }),
  ...
  [
    ...
    new Key("y", {}, "Y"),
    new Key("u", {}, "U"),
    new Key("ı", { secondaryKey: "I" }, "ı"),
    new Key("o", {}, "O"),
    new Key("p", {}, "P"),
    new Key("ğ", { secondaryKey: "Ğ" }, "ğ"),
    new Key("ü", { secondaryKey: "Ü" }, "ü"),
  ],
  [
    new Key(
      "Caps Lock",
    ...
    new Key("k", {}, "K"),
    new Key("l", {}, "L"),
    new Key("ş", { secondaryKey: "Ş" }, "ş"),
    new Key("i", { secondaryKey: "İ" }, "i"),
    new Key(
      "Enter",
  ...
  [
    new Key(
      "Shift",
      { position: ["bottom", "left"], width: 140, inert: true },
      "shift",
    ),
    new Key("<", { secondaryKey: ">" }),
    new Key("z", {}, "Z"),
